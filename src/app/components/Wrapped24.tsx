...
function Wrapped24() {
  return (
    <div>
      <ReactMarkdown>
      # Ibrohim Abdivokhidov Wrapped 2024
...
- Created accounts on all social platforms: LinkedIn, YouTube, X (twitter), Instagram, Twitch, etc. [here](#my-socials)
...
- Applied to the IES program in Berlin, Germany. [here](#useful-links)
...
### July
- Finished the next version of CoMedAI and successfully completed the Buildspace, Night&Weekends s5 program. [^52], [^9]
...
- Listed all 42 of my applications on Patreon. [here](#useful-links), [^69]
- Started researching how to optimize AlphaFold using Quantum Gates. [^70]
- Accepted but couldn't attend the Hack the North hackathon in Canada. [here](#useful-links)
...
- Received the first invitation for a Skype interview for the IES program in Berlin, Germany. [here](#useful-links)
...
- Submitted my Knight-Hennessy Scholarship application. [here](#useful-links)
...
- Changed: Started researching: **Code optimization for STM-32 f103/STM-32 F407 Discovery Time and Memory** and **ASCON: Lightweight Cryptography**. [^76], [^9]
...
- Started reading **"The Pathless Path"** by Paul Millerd. [here](#useful-links)
- Received a second invitation for a Skype interview for the IES program in Berlin, Germany. [here](#useful-links)
...
- Applied to the **Young Leaders Fellowship**, Global Program. (currently in the interview phase). [here](#useful-links)
...
**PPS:** I tried to include everything that stood out the most throughout the year, as much as I could remember.
...
- YouTube: https://www.youtube.com/@TechWithAbee
- Twitch: https://www.twitch.tv/abdibrokhim 
- Discord: @abdibrokhim 
- Dev: https://dev.to/abdibrokhim
- Medium: https://medium.com/@abdibrokhim 
- Lablabai: https://lablab.ai/u/@abdibrokhim 

---

### Other Socials
- Personal webpage: https://abdibrokhim.vercel.app/ 
- Buy me a Coffee: https://buymeacoffee.com/abdibrokhim 
- Telegram: https://www.t.me/abdibrokhim
- Instagram: https://www.instagram.com/that21savage_
- Devpost: https://devpost.com/abdibrokhim  
- Leetcode: https://leetcode.com/u/abdibrokhim/ 
- Reddit: https://www.reddit.com/user/abdibrokhim/ 
- Quora: https://www.quora.com/profile/Ibrohim-Abdivokhidov
- HuggingFace: https://huggingface.co/abdibrokhim/ 
- Codeforces: https://codeforces.com/profile/abdibrokhim 
- Kaggle: https://www.kaggle.com/loneguy 
- Dmoj (outdated): https://dmoj.ca/user/abdibrokhim
- Linktree profile (outdated, lol): https://linktr.ee/abdibrokhim 
- Milkshake profile (outdated): https://msha.ke/abdibrokhim/ 
- Plum profile (outdated, lol): https://secure.plum.io/en/p/Oap2QYNbeX7n3y2t3cQeAg
